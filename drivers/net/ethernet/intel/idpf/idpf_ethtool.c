...
static const struct idpf_stats idpf_gstrings_port_stats[] = {
	...
	IDPF_PORT_STAT("rx_packets", netstats.rx_packets),
	IDPF_PORT_STAT("rx_bytes", port_stats.vport_stats.rx_bytes),
	IDPF_PORT_STAT("rx_unicast", port_stats.vport_stats.rx_unicast),
	IDPF_PORT_STAT("rx_multicast", port_stats.vport_stats.rx_multicast),
	IDPF_PORT_STAT("rx_broadcast", port_stats.vport_stats.rx_broadcast),
	IDPF_PORT_STAT("rx_discards", port_stats.vport_stats.rx_discards),
	IDPF_PORT_STAT("rx_unknown_protocol", port_stats.vport_stats.rx_unknown_protocol),
	IDPF_PORT_STAT("tx_packets", netstats.tx_packets),
	IDPF_PORT_STAT("tx_bytes", port_stats.vport_stats.tx_bytes),
	IDPF_PORT_STAT("tx_unicast", port_stats.vport_stats.tx_unicast),
	IDPF_PORT_STAT("tx_multicast", port_stats.vport_stats.tx_multicast),
	IDPF_PORT_STAT("tx_broadcast", port_stats.vport_stats.tx_broadcast),
	IDPF_PORT_STAT("tx_discards", port_stats.vport_stats.tx_discards),
...
#ifndef UNIFIED_STATS
	IDPF_PORT_STAT("tx_tcp_segments", port_stats.extra_stats.tx_tcp_segs),
	IDPF_PORT_STAT("tx_udp_segments", port_stats.extra_stats.tx_udp_segs),
	IDPF_PORT_STAT("tx_tcp_cso", port_stats.extra_stats.tx_tcp_cso),
	IDPF_PORT_STAT("tx_udp_cso", port_stats.extra_stats.tx_udp_cso),
	IDPF_PORT_STAT("tx_sctp_cso", port_stats.extra_stats.tx_sctp_cso),
	IDPF_PORT_STAT("tx_ip4_cso", port_stats.extra_stats.tx_ip4_cso),
	IDPF_PORT_STAT("rx_tcp_cso", port_stats.extra_stats.rx_tcp_cso),
	IDPF_PORT_STAT("rx_udp_cso", port_stats.extra_stats.rx_udp_cso),
	IDPF_PORT_STAT("rx_sctp_cso", port_stats.extra_stats.rx_sctp_cso),
	IDPF_PORT_STAT("rx_ip4_cso", port_stats.extra_stats.rx_ip4_cso),
	IDPF_PORT_STAT("rx_tcp_cso_error", port_stats.extra_stats.rx_tcp_cso_err),
	IDPF_PORT_STAT("rx_udp_cso_error", port_stats.extra_stats.rx_udp_cso_err),
	IDPF_PORT_STAT("rx_sctp_cso_error", port_stats.extra_stats.rx_sctp_cso_err),
	IDPF_PORT_STAT("rx_ip4_cso_error", port_stats.extra_stats.rx_ip4_cso_err),
	IDPF_PORT_STAT("rx_csum_complete", port_stats.extra_stats.rx_csum_complete),
	IDPF_PORT_STAT("rx_csum_unnecessary", port_stats.extra_stats.rx_csum_unnecessary),
#else /* !UNIFIED_STATS */
	IDPF_PORT_STAT("port-tx-tcp_segments_count", port_stats.extra_stats.tx_tcp_segs),
	IDPF_PORT_STAT("port-tx-udp_segments_count", port_stats.extra_stats.tx_udp_segs),
	IDPF_PORT_STAT("port-tx-tcp-csum-offload_count", port_stats.extra_stats.tx_tcp_cso),
	IDPF_PORT_STAT("port-tx-udp-csum-offload_count", port_stats.extra_stats.tx_udp_cso),
	IDPF_PORT_STAT("port-tx-sctp-csum-offload_count", port_stats.extra_stats.tx_sctp_cso),
	IDPF_PORT_STAT("port-tx-ip4_csum-offload_count", port_stats.extra_stats.tx_ip4_cso),
	IDPF_PORT_STAT("port-rx-tcp-csum-offload_count", port_stats.extra_stats.rx_tcp_cso),
	IDPF_PORT_STAT("port-rx-udp-csum-offload_count", port_stats.extra_stats.rx_udp_cso),
	IDPF_PORT_STAT("port-rx-sctp-csum-offload_count", port_stats.extra_stats.rx_sctp_cso),
	IDPF_PORT_STAT("port-rx-ip4-csum-offload_count", port_stats.extra_stats.rx_ip4_cso),
	IDPF_PORT_STAT("port-rx-tcp-csum_errors", port_stats.extra_stats.rx_tcp_cso_err),
	IDPF_PORT_STAT("port-rx-udp-csum_errors", port_stats.extra_stats.rx_udp_cso_err),
	IDPF_PORT_STAT("port-rx-sctp-csum_errors", port_stats.extra_stats.rx_sctp_cso_err),
	IDPF_PORT_STAT("port-rx-ip4-csum_errors", port_stats.extra_stats.rx_ip4_cso_err),
	IDPF_PORT_STAT("port-rx-csum-complete-offload", port_stats.extra_stats.rx_csum_complete),
	IDPF_PORT_STAT("port-rx-csum-unnecessary", port_stats.extra_stats.rx_csum_unnecessary),
#endif /* !UNIFIED_STATS */
...
static void idpf_collect_queue_stats(struct idpf_vport *vport)
{
	...
	for (i = 0; i < vport->num_rxq_grp; i++) {
		...
		for (j = 0; j < num_rxq; j++) {
			...
			/* To avoid invalid statistics values, ensure that we keep retrying
			 * the copy until we get a consistent value according to
			 * u64_stats_fetch_retry. But first, make sure our queue is
			 * non-null before attempting to access its syncp.
			 */
			do {
